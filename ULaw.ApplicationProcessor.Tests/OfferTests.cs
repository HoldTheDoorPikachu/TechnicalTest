...
namespace ULaw.ApplicationProcessor.Tests
{
    ...
    {                                                                       //this makes it easier to visually compare strings... incase you want to... refactor them ;)
        ...
        private const string RejectionEmailForAnyThirdDegreeResult          = @"<html><body><h1>Your Recent Application from the University of Law</h1><p> Dear Test, </p><p/> Further to your recent application, we are sorry to inform you that you have not been successful on this occasion.<br/> If you wish to discuss the decision further, or discuss the possibility of applying for an alternative course with us, please contact us at AdmissionsTeam@Ulaw.co.uk.<br/> Yours sincerely,<p/> The Admissions Team,</body></html>"; //that was so subtle and very naughty!  Hmm, I just re-read the Word Doc.  Apparently this violates RULE NUMBER THREE.  I don't care if it's the Prime Directive, that slash needed to be there for it to be valid HTML!  :D

        //I'm not sure if I should refactor these strings.  I could do something like I did in the ApplicationHelper, but I'm concerned it may make these test strings too difficult to manually compare properly.  My inner artist feels like I'd need to see another dozen lines like these before I'd refactor to overcome the convenience factor with the longterm maintainability score. 
        //of course, refactoring should have made the issue on ln 19 easier to fix, or eliminated it entirely...

        [TestMethod]
        public void ApplicationSubmissionWithFirstLawDegree()
        {
            Application thisSubmission = new Application(DegreeGradeEnum.first, DegreeSubjectEnum.law, "Law", "ABC123", new DateTime(2019, 9, 22), "Mr", "Test", "Tester", new DateTime(1991, 08, 14), false);

            string emailHtml = ApplicationHelper.Process(thisSubmission);
        ...
        {
            Application thisSubmission = new Application(DegreeGradeEnum.first, DegreeSubjectEnum.lawAndBusiness, "Law", "ABC123", new DateTime(2019, 9, 22), "Mr", "Test", "Tester", new DateTime(1991, 08, 14), false);
        ...
        {
            Application thisSubmission = new Application( DegreeGradeEnum.first, DegreeSubjectEnum.English, "Law", "ABC123", new DateTime(2019, 9, 22), "Mr", "Test", "Tester", new DateTime(1991, 08, 14), false);
        ...
        {
            Application thisSubmission = new Application(DegreeGradeEnum.twoOne, DegreeSubjectEnum.law,"Law", "ABC123", new DateTime(2019, 9, 22), "Mr", "Test", "Tester", new DateTime(1991, 08, 14), false);
        ...
        {
            Application thisSubmission = new Application(DegreeGradeEnum.twoOne, DegreeSubjectEnum.maths,"Law", "ABC123", new DateTime(2019, 9, 22), "Mr", "Test", "Tester", new DateTime(1991, 08, 14), false);
        ...
        {
            Application thisSubmission = new Application(DegreeGradeEnum.twoOne, DegreeSubjectEnum.lawAndBusiness, "Law", "ABC123", new DateTime(2019, 9, 22), "Mr", "Test", "Tester", new DateTime(1991, 08, 14), false);
        ...
        {
            Application thisSubmission = new Application(DegreeGradeEnum.twoTwo, DegreeSubjectEnum.English,"Law", "ABC123", new DateTime(2019, 9, 22), "Mr", "Test", "Tester", new DateTime(1991, 08, 14), false);
        ...
        {
            Application thisSubmission = new Application( DegreeGradeEnum.twoTwo, DegreeSubjectEnum.law,"Law", "ABC123", new DateTime(2019, 9, 22), "Mr", "Test", "Tester", new DateTime(1991, 08, 14), false);
        ...
        {
            Application thisSubmission = new Application(DegreeGradeEnum.third, DegreeSubjectEnum.maths, "Law", "ABC123", new DateTime(2019, 9, 22), "Mr", "Test", "Tester", new DateTime(1991, 08, 14), false);
